                                    ...
                                    <div class="inner-slide">
                                        <div class="single-product">
                                            <div class="product-img">
                                                <a href="javascript:void(0)">
                                                    <img class="primary-img" src="images/2.jpg" alt="Uren's Product Image">
                                                    <img class="secondary-img" src="images/2.jpg" alt="Uren's Product Image">
                                                </a>
                                                <!-- <div class="sticker">
                                            ...
                                            <div class="product-content">
                                                <div class="product-desc_info">
                                                    ...
                                                    <h6><a class="product-name" href="single-product.html">Sample</a></h6>
                                                    <div class="price-box">
