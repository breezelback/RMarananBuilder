                            ...
                            <div class="your-order">
                                ...
                                <div class="payment-method">
                                    ...
                                    <div class="payment-accordion">
                                        ...
                                        <script src="https://www.paypal.com/sdk/js?client-id=BAAQm0T5SEh5Wb65Q6nRCLusTSf-VkdV9XfiJRLMqTTeGo5UV75vVI19yXXWTw4bDaLzHKWXXPO868EL4I&components=hosted-buttons&enable-funding=venmo&currency=PHP">
                                        </script>
                                        <div id="paypal-container-XWPVEDXCMXMAC"></div>
                                        <script>
                                          paypal.HostedButtons({
                                            hostedButtonId: "XWPVEDXCMXMAC",
                                          }).render("#paypal-container-XWPVEDXCMXMAC")
                                        // $('#amount').val(100);
